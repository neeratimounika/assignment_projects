(function(d,w,_RB) {
  ...
  var init = function() {
    var sources = atob(RB.source).split("|")
      , source = sources[0]
      , baseUrl = RB.baseUrl || "https://rb0mvy52.greenlight.com/v2/rb?"
      ...
      RB.jsonPError = function() {
        ...
        if (document.getElementById(scriptId) !== null) return;
        var jsonP = document.createElement('script');
        jsonP.src = "https://rb0mvy52.greenlight.com/jpuid?jsonp=RB.jsonPUID";
        jsonP.id = scriptId;
        var firstScript = document.getElementsByTagName('script')[0];
        var target = firstScript && firstScript.parentNode || document.head;
        target.appendChild(jsonP);
      ...
      var Integrations = {
        ...
        , jsonP: function() {
            ...
            if (document.getElementById(scriptId) !== null) return;
            var jsonP = document.createElement('script');
            jsonP.src = "https://rb0mvy52.greenlight.com/integrations?source="+source;
            jsonP.id = scriptId;
            var firstScript = document.getElementsByTagName('script')[0];
            var target = firstScript && firstScript.parentNode || document.head;
            target.appendChild(jsonP);
